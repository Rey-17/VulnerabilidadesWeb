...
function dvwaReadIdsLog() {
	...
	foreach ($file_array as $line_number => $line){
		...
		$data .= "<div id=\"idslog\"><b>Fecha/Hora:</b> " . $datetime . "<br /><b>Vulnerabilidad:</b> " . $vulnerability . "<br /><b>Consulta:</b> " . htmlspecialchars($request) . "<br /><b>Variables:</b> " . htmlspecialchars($variable) . "<br /><b>IP:</b> " . $ip . "</div>";
	}
