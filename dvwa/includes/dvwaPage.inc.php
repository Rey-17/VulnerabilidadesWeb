...
function &dvwaPageNewGrab() {
	...
	$returnArray = array(
		'title' => 'Defensas web'.dvwaVersionGet().'',
		'title_separator' => ' :: ',
		'body' => '',
		'page_id' => '',
		'help_button' => '',
...
function dvwaHtmlEcho( $pPage ) {
	...
	//$menuBlocks['vulnerabilities'][] = array( 'id' => 'exec', 'name' => 'Ejecución de Comandos', 'url' => 'vulnerabilities/exec/.' );
...
<html xmlns=\"http://www.w3.org/1999/xhtml\">
	...
	<body class=\"home\">
		<div id=\"container\">
			...
			<div id=\"header\">
                <img src='http://localhost:8080/Cross-Site-Scripting/dvwa/images/logofiec.png' id='imagenheader'>
				<h1 id='titulo'>Vulnerabilidades Web</h1>
			...
			<div id=\"footer\">
				...
				<p>Vulnerabilidades Web - Defensas Web ".dvwaVersionGet()."<br>
				Reynaldo Villarreal<br>Samuel Labrador</p>
