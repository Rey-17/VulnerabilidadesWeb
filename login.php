...
if( isset( $_POST[ 'Login' ] ) ) {
	...
	if( $result && mysql_num_rows( $result ) == 1 ) {	// Login Successful...
		...
		dvwaLogin( $user );
		dvwaRedirect( 'vulnerabilities/xss_s/index.php' );
...
<html xmlns=\"http://www.w3.org/1999/xhtml\">
	...
	<head>
		...
		<title>Aplicacion web-Vulnerabilidades (DVWA) - Login</title>
	...
	<fieldset>
			...
			<p class=\"submit\"><input type=\"submit\" value=\"Iniciar\" name=\"Login\"></p>
